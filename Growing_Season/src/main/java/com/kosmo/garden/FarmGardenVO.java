...
public class FarmGardenVO {
	...
	public int getFglatitude() {
		return fglatitude;
	}
	public void setFglatitude(int fglatitude) {
		this.fglatitude = fglatitude;
	}
	public int getFglongitude() {
		return fglongitude;
	}
	public void setFglongitude(int fglongitude) {
