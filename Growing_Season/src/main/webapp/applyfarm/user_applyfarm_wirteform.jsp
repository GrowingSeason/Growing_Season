			...
			<div class="agileits_mail_grids">
					<div class="col-md-7 agileits_mail_grid_left">
						...
						<form class="inputboxes" action="#" method="post">
							<h4>신청자명</h4>
							<input type="text" name="apname" value="${MEMBER_DETAIL.mname}" placeholder="이름을 입력해주세요" required readonly>
							<h4>연락처</h4>
							<input type="text" name="apphone" value="${MEMBER_DETAIL.mphone}" placeholder="연락처를 입력해주세요" required readonly>
							<h4>주소</h4>
							<input type="text" name="addr" value="${MEMBER_DETAIL.maddress}" placeholder="주소를 입력해주세요" required readonly>
							<h4>이메일</h4>
							<input type="text" name="apemail" value="${MEMBER_DETAIL.memail}" placeholder="이메일을 입력해주세요" required readonly>
							<h4>생년월일</h4>
							<input type="text" name="apbirth" value="${MEMBER_DETAIL.mbirth}" placeholder="생일을 입력해주세요" required readonly>
