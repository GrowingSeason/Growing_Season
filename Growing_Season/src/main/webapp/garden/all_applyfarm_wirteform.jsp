    ...
    <div class="container">
        ...
        <div class="row">
          <div class="span6 shadow">
            ...
            <form id="contactform" action="/paymentSelect.do" method="post" role="form" class="contactForm">
              ...
              <div class="row">
                <div class="span6 margintop10 field form-group">
                  <label for="exampleInputEmail1">신청자명</label>	
                ...
                <div class="span6 margintop10 field form-group">
                  ...
                  <input type="text" name="pw" placeholder="패스워드를 입력해주세요" required>
                  <div class="validation"></div>
                </div>
                <div class="span6 margintop10 field form-group">
                  <label for="exampleInputEmail1">패스워드 확인</label>	
                  <input type="text" name="pwcheck" placeholder="패스워드 다시한번 입력해주세요" required>
                  <div class="validation"></div>
                </div>
              </div>
            </form>
