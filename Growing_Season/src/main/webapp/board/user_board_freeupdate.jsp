...
<section id="content">
	<div class="container">
		...
		<form action="/boardfreeupdate.do" class="boardUpdate" method="get">
			...
			background: #eceae6;   
				...
				<div class="input-group" align="center"
					...
					<input name="btitle" type="text" size=160
						value="${FREE_UPDATE_PAGE.btitle}"
			...
			<div class="row">
				...
				<div class="input-group" align="center"
					style="display: inline-block;">
					<textarea name="bcon" style="width: 999px; height: 500px;">${FREE_UPDATE_PAGE.bcon}</textarea>
				</div>
			</div>
			<div align="right">
		...
		<div align="right">
			<button class="btn btn-inverse"><a href="/boardfreedelete.do?bseq=${FREE_UPDATE_PAGE.bseq}"><b><font color="white">삭제</font></b></a></button>
			<button class="btn btn-inverse"><a href="/boardfreedetail.do?bseq=${FREE_UPDATE_PAGE.bseq}"><b><font color="white">취소</font></b></a></button>
		</div>
	</div>
	<style>
			h4 {
