		...
		<table align="center" border=1px width=95%>
			...
			<tbody>
				<tr align="center">
					<td>${FBPOP_UP.bseq}</td>
					<td>${FBPOP_UP.mid}</td>
					<td>${FBPOP_UP.btitle}</td>
					<td>${FBPOP_UP.bcon}</td>
					<td>${FBPOP_UP.bregdate}</td>
				</tr>
			</tbody>
		</table>
...
<form action="/freebdeclarationinsert.do" class="bdeclarationInsert" method="post">
<input type="hidden" name="bseq" value="${FBPOP_UP.bseq}">
