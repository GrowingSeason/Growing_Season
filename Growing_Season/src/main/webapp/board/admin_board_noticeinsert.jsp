...
<section id="content">
	<div class="container">
		<div class="row">
			<div class="span10">
				<form action="/boardnoticeinsert.do" class="boardInsert"
					enctype="multipart/form-data" method="post">
					<div class="row">

						<input name="btitle" value="" type="text" placeholder="제목을 입력하세요"
				...
				<div align="right">
					...
					<button class="btn btn-inverse">
						<a href="/boardnoticelist.do"><b><font color="white">취소</font></b></a>
					</button>
				</div>
			</div>
			<style>
