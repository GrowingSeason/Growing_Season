		...
		<div class="row">
			<div class="span10">
				<table border=1 width=100%>
					...
					<tbody>
						<tr align="center">
							<td height=50>${flistMap.freedetail.mid}</td>
							<td height=50>${flistMap.freedetail.btitle}</td>
							<td height=50>${flistMap.freedetail.bregdate}</td>
						</tr>
						<tr style="background: #8fc04e" align="center">
							<th colspan='3'><font size="3" color="#464646">글내용</font></th>
						</tr>
						<tr align="center">
							<td colspan='3' height=500>${flistMap.freedetail.bcon}</td>
						</tr>
				...
				<div align="right">
					<button class="btn btn-inverse">
						<a href="/boardfreelist.do"><b><font color="white">목록보기</font></b></a>
					</button>
					<c:choose>
						<c:when test="${MSEQ == flistMap.freedetail.mseq}">
							<button class="btn btn-inverse">
								<a
									href="/boardfreeupdatepage.do?bseq=${flistMap.freedetail.bseq}"><b><font color="white">수정</font></b></a>
							</button>
							<button class="btn btn-inverse">
								<a href="/boardfreedelete.do?bseq=${flistMap.freedetail.bseq}"><b><font color="white">삭제</font></b></a>
							</button>
						</c:when>
					</c:choose>
					<c:choose>
				...
				<br>
				<div>
					<form action="/replyfreeinsert.do" class="replyInsert"
						method="post">

						<label style="display: inline;">댓글</label> &nbsp;&nbsp;&nbsp;
						<div style="display: inline;">
							<input type="hidden" name="bseq"
								value="${flistMap.freedetail.bseq}"> <input
					...
					<div style="margin: -25px -15px 75px;">
						...
						<div align="center">
							<ul class="pagination">${FREE_REPLY_PAGING}
							</ul>
						</div>
					</div>
				</div>
...
function UpPopup(seq) {
	window.open("/freereplyupdatepopup.do?rseq="+seq,
			"댓글수정창",
